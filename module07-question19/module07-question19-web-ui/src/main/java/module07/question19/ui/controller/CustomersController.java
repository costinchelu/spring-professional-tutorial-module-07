package module07.question19.ui.controller;

import module07.question19.ui.client.BackendClient;
...
public class CustomersController {
    ...
    public CustomersController(BackendClient backendClient) {
...
//        ResponseEntity<Customers> responseEntity = restTemplate.getForEntity(backendUrl + "/api/customers", Customers.class);
        ...
        // or better, we can use OpenFeign:
         var responseEntity = backendClient.getCustomers();
...
//            ResponseEntity<Customer> responseEntity = restTemplate.postForEntity(backendUrl + "/api/customers", customer, Customer.class);
            ...
            // or OpenFeign:
             var responseEntity = backendClient.postCustomer(customer);
